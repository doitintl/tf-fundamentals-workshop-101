...
output "sec_grp_host_postgresql_private" {
  value = aws_security_group.sec_grp_host_postgresql_private.id
}
...
output "sec_grp_host_ssh_app_private" {
  value = aws_security_group.sec_grp_host_ssh_app_private.id
}
