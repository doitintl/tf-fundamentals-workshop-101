...
# --
# @info:         1st ec2-bastion-instance [001/001]
# @entity/id:    doit_core_ec2_bastion_host_ubuntu_20_04
# @source/local: aws/modules/project/services/ec2-bastion
# --
module "doit_core_ec2_bastion_host_ubuntu_20_04" {

  enabled = true
  source  = "./aws/modules/project/services/ec2-bastion"
  ...
  set_size_min      = 1
  set_size_desired  = 1
  set_instance_type = var.ec2_bastion_instance_type

  set_root_volume_size = var.ec2_bastion_storage_root_allocated
  set_root_volume_type = var.ec2_bastion_storage_root_type
