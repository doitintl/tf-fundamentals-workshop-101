...
- [terraform-aws-ec2-backend-server](https://github.com/cloudposse/terraform-aws-ec2-backend-server) - Terraform module to define a generic backend host with parameterized user data
